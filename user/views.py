...
from .serializers import ProfileRegisterSerializer, ProfileLoginSerializer, StuffRegisterSerializer, \
    StuffLoginSerializer, \
    CourierRegisterSerializer, CourierLoginSerializer
